...
describe('Brand e2e test', () => {
  ...
  const brandSample = { acronym: 'hedge hence', name: 'duh eminent' };
  ...
  describe('new Brand page', () => {
    ...
    it('should create an instance of Brand', () => {
      cy.get(`[data-cy="acronym"]`).type('near circa till');
      cy.get(`[data-cy="acronym"]`).should('have.value', 'near circa till');

      cy.get(`[data-cy="name"]`).type('atop');
      cy.get(`[data-cy="name"]`).should('have.value', 'atop');

      cy.get(`[data-cy="description"]`).type('hybridisation');
      cy.get(`[data-cy="description"]`).should('have.value', 'hybridisation');
