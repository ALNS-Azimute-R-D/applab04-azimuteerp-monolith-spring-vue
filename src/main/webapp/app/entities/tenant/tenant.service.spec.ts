...
describe('Service Tests', () => {
  describe('Tenant Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Tenant', async () => {
      ...
      it('should partial update a Tenant', async () => {
      ...
      it('should not partial update a Tenant', async () => {
      ...
      it('should not return a list of Tenant', async () => {
        axiosStub.get.rejects(error);
