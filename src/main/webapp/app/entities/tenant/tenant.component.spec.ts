  ...
  describe('Tenant Management Component', () => {
    ...
    describe('Mount', () => {
      it('Should call load all on init', async () => {
        // GIVEN
        tenantServiceStub.retrieve.resolves({ headers: {}, data: [{ id: 123 }] });
      ...
      it('should calculate the sort attribute for an id', async () => {
        ...
        // THEN
        expect(tenantServiceStub.retrieve.lastCall.firstArg).toMatchObject({
          sort: ['id,asc'],
        });
      });
    });
    describe('Handles', () => {
      ...
      it('should load a page', async () => {
        ...
        // THEN
        expect(tenantServiceStub.retrieve.called).toBeTruthy();
        expect(comp.tenants[0]).toEqual(expect.objectContaining({ id: 123 }));
      });
      ...
      it('should not load a page if the page is the same as the previous page', () => {
        ...
        // THEN
        expect(tenantServiceStub.retrieve.called).toBeFalsy();
      });
