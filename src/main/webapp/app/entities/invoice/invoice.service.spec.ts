...
describe('Service Tests', () => {
  describe('Invoice Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Invoice(123, 'AAAAAAA', currentDate, currentDate, 'AAAAAAA', 0, 0, 0, 0, 0, 0, 'PAID_ONCE', 'AAAAAAA', 'INACTIVE');
    });
        ...
        const returnedFromService = Object.assign(
          {
            ...
            dueDate: dayjs(currentDate).format(DATE_TIME_FORMAT),
          },
          elemDefault,
        );
