...
type OrganizationComponentType = InstanceType<typeof Organization>;
...
describe('Component Tests', () => {
  ...
  describe('Organization Management Component', () => {
    ...
    let mountOptions: MountingOptions<OrganizationComponentType>['global'];
    ...
    describe('Mount', () => {
      it('Should call load all on init', async () => {
        ...
        // WHEN
        const wrapper = shallowMount(Organization, { global: mountOptions });
        const comp = wrapper.vm;
        await comp.$nextTick();

        // THEN
        expect(organizationServiceStub.retrieve.calledOnce).toBeTruthy();
      ...
      it('should calculate the sort attribute for an id', async () => {
        ...
        // THEN
        expect(organizationServiceStub.retrieve.lastCall.firstArg).toMatchObject({
          sort: ['id,asc'],
        });
      });
    });
    describe('Handles', () => {
      let comp: OrganizationComponentType;
      ...
      beforeEach(async () => {
        ...
        organizationServiceStub.retrieve.resolves({ headers: {}, data: [] });
      });
