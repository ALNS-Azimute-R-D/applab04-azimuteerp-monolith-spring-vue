  ...
  setup() {
    ...
    const retrieveActivitys = async () => {
      ...
      try {
        ...
        const res = await activityService().retrieve(paginationQuery);
    ...
    const removeActivity = async () => {
      try {
        ...
        const message = t$('azimuteErpSpringVueMonolith04App.activity.deleted', { param: removeId.value }).toString();
