...
kubectl scale deployment <app-name> --replicas <replica-count> -n azimuteerp-platform
...
kubectl set image deployment/<app-name>-app <app-name>=<new-image> -n azimuteerp-platform
